...
The easiest way to include them is to add the shader variant collection `glTFExport` to the list of *Preloaded Shaders* under *Project Settings* > *Graphics* > *Shader Loading*.
